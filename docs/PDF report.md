...
### Таблица
Колонка 1
    Заголовок - Смета/Вид работы
    Значение
        Первый уровень - smeta_code
        Второй уровень (вложенный в первый) - description
Колонка 2
    Заголовок - Ед. изм. 
    Значение - unit
Колонка 3
...
Внизу в правом углу указывается номер страницы и общее количество страниц в отчете.

### Оформление
    Заголовок таблицы - выделяется темным серым 
    Уровень smeta_code - выделяется средне серым
    По строкам таблицы делается зебра светло серым цветом через строку
    Промежуточные итоги жирным шрифтом
    ...
    Столбцы Ед. изм., Объем, Сумма - занимает минимально необходимую ширину, чтобы были видны значения
    Столбец Смета/Вид работы имеет максимальную ширину
