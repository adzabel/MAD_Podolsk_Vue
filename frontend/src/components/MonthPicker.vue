...
.month-picker__toggle { display: inline-flex; align-items: center; gap: 12px; background: var(--bg-card); border: 1px solid var(--border-soft); padding: 0 12px; border-radius: 10px; cursor: pointer; min-width: 200px; min-height: var(--control-height); height: var(--control-height); }
